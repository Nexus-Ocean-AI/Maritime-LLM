"""
Fine-tune Qwen3-30B for Maritime Domain - Version 2 (Continue Training)

This script continues training from existing checkpoint with:
- Train/Validation/Test dataset splits
- 2 epochs of training on new data
- Evaluation on validation set

Usage:
    python finetune_qwen3_v2.py
    
    # Custom checkpoint path
    python finetune_qwen3_v2.py --checkpoint outputs_qwen3_finetune/checkpoint-1533
    
    # Custom dataset
    python finetune_qwen3_v2.py --dataset processed_queries_20251217_125255.jsonl
"""
...
CHECKPOINT_PATH = "outputs_qwen3_finetune/checkpoint-1533"  # Latest checkpoint
MAX_SEQ_LENGTH = 4096
...
# LoRA Config (should match the original training)
LORA_R = 64
LORA_ALPHA = 128
LORA_DROPOUT = 0
...
TRAINING_CONFIG = {
    ...
    "warmup_ratio": 0.03,
    "num_train_epochs": 3,  # Only 2 epochs for continuation
...
OUTPUT_DIR = "outputs_qwen3_finetune_v2"
...
def run_continued_training(args):
    ...
    """
    print("\n" + "=" * 80)
    print("🚢 QWEN3-30B MARITIME FINE-TUNING - CONTINUED TRAINING")
    print("=" * 80 + "\n")
    ...
    if not os.path.exists(checkpoint_path):
        ...
        base_dir = os.path.dirname(checkpoint_path) or "outputs_qwen3_finetune"
...
def main():
    parser = argparse.ArgumentParser(
        description="Continue fine-tuning Qwen3-30B from checkpoint"
    )
    parser.add_argument(
        "--checkpoint",
        type=str,
